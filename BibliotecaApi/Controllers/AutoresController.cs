...
public class AutoresController : ControllerBase
{
    ...
    /// </summary>
    /// <returns>Lista de autores com seus livors associados</returns>
    ...
    /// <param name="autor">Dados atualizados do autor.</param>
    /// <returns>Nenhum conteúdo.</returns>
    /// <response code="204">Autor atualizado com sucesso.</response>
    /// <response code="404">Autor não encontrado.</response>
    [HttpPut("{id:int}")]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]    public IActionResult Atualizar(int id, [FromBody] Autor autor)
    {
