...
public class EmprestimosController : ControllerBase
{
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]    public IActionResult ObterPorId(int id)
    {
    ...
    /// Caso contrário, será retornado erro de conflito.
    ///
    ...
    /// <response code="201">Empréstimo realizado com sucesso.</response>
    ...
    /// <response code="200">Devolução realizada com sucesso.</response>
